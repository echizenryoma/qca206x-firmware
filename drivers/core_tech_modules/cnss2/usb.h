...
static inline int cnss_usb_call_driver_probe(struct cnss_usb_data *usb_priv)
{
	return 0;
}
static inline int cnss_usb_call_driver_remove(struct cnss_usb_data *usb_priv)
{
	return 0;
}
...
static inline int cnss_usb_unregister_driver_hdlr(struct cnss_usb_data *usb_priv)
{
	return 0;
}
...
static inline int cnss_usb_dev_shutdown(struct cnss_usb_data *usb_priv)
{
	return 0;
}
#endif
